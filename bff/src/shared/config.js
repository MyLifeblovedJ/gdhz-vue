...
export const config = {
  ...
  ai: {
    ...
    historyRecallMaxTurns: readNumber('AI_HISTORY_RECALL_MAX_TURNS', 10),
    historyRecallMaxCharsPerMsg: readNumber('AI_HISTORY_RECALL_MAX_CHARS_PER_MSG', 500),
    historyRecallMaxTotalChars: readNumber('AI_HISTORY_RECALL_MAX_TOTAL_CHARS', 6000),
