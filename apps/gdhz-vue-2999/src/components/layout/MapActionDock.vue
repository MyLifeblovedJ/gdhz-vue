...
const secondaryActions = [
  ...
  { key: 'wind', label: '风速', icon: 'fa-solid fa-wind', event: 'toggle-wind', activeProp: 'windActive' },
...
/* Floating tooltip label — no layout reflow */
.dock-btn-tooltip {
  position: absolute;
  bottom: calc(100% + 8px);
  left: 50%;
...
/* ===== Windy-style continuous gradient legend ===== */
.wave-legend-bar {
  display: flex;
  align-items: center;
  padding: 0;
