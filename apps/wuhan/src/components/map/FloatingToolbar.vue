    ...
    <div class="left-controls">
      ...
      <div class="toolbar-buttons">
        ...
        >
          ...
          <span class="toolbar-label">图层控制</span>
        </button>
        <button
        ...
        >
          ...
          <span class="toolbar-label">观测设备</span>
        </button>
        ...
        <div class="halo-ai-btn" @click="toggleAIPanel" title="AI 智能助手" :class="{ active: showAIPanel }">
          ...
          <span class="toolbar-label ai-label">智能助手</span>
        </div>
      </div>
    </div>
        ...
        <div class="dialog-content ai-layout-shell">
          ...
          <section class="ai-chat-pane">
            ...
            <div class="welcome-shell" v-if="showWelcomeHero">
              <h2 class="welcome-title">您好，我是海洋渊听智能助手</h2>
...
.halo-ai-btn:hover .toolbar-label {
  opacity: 1;
  transform: translateY(-50%) translateX(0);
}
...
.toolbar-btn.active .toolbar-label {
  ...
  color: var(--accent-cyan);
  box-shadow: 0 4px 16px rgba(0, 0, 0, 0.4), 0 0 8px rgba(0, 229, 255, 0.1);
}

.toolbar-btn.devices.active .toolbar-label {
  border-color: rgba(16, 185, 129, 0.3);
  color: #10b981;
  box-shadow: 0 4px 16px rgba(0, 0, 0, 0.4), 0 0 8px rgba(16, 185, 129, 0.1);
}

/* AI 按钮标签特殊样式 */
.toolbar-label.ai-label {
  border-color: rgba(139, 92, 246, 0.3);
  color: #c4b5fd;
  box-shadow: 0 4px 16px rgba(0, 0, 0, 0.4), 0 0 8px rgba(139, 92, 246, 0.1);
}

.halo-ai-btn.active .toolbar-label.ai-label {
  color: #e9d5ff;
  border-color: rgba(139, 92, 246, 0.5);
  box-shadow: 0 4px 16px rgba(0, 0, 0, 0.4), 0 0 12px rgba(139, 92, 246, 0.2);
}
