<template>
  <div class="tool-rail">
    ...
    >
      ...
      <span class="tool-label">图层控制</span>
    </button>
    <button
      v-if="showDeviceBtn"
      class="tool-btn"
    ...
    >
      ...
      <span class="tool-label">观测设备</span>
    </button>
    <button
      v-if="showAIBtn"
    ...
    >
      ...
      <span class="tool-label ai-tool-label">智能助手</span>
    </button>
  </div>
</template>
...
.tool-label {
  ...
  box-shadow: 0 6px 20px rgba(15, 23, 42, 0.12), 0 0 1px rgba(15, 23, 42, 0.06);
  pointer-events: none;
  opacity: 0;
...
.tool-label::after {
  ...
  width: 8px;
  height: 8px;
  background: linear-gradient(135deg, transparent 50%, rgba(255, 255, 255, 0.96) 50%);
...
.tool-btn.active .tool-label {
  color: #8a5a00;
  border-color: rgba(196, 134, 28, 0.2);
  background: linear-gradient(180deg, rgba(255, 248, 236, 0.98), rgba(248, 237, 214, 0.92));
  box-shadow: 0 6px 20px rgba(196, 134, 28, 0.14), 0 0 1px rgba(196, 134, 28, 0.08);
}

.tool-btn.active .tool-label::after {
  background: linear-gradient(135deg, transparent 50%, rgba(248, 237, 214, 0.92) 50%);
  border-color: rgba(196, 134, 28, 0.2);
}
