...
(function () {
    ...
    class Shader {
        ...
        cursor: grab;
        backdrop-filter: url(#${this.id}_filter) blur(0.25px) contrast(1.02) brightness(1.01) saturate(1.02);
        z-index: 9999;
        pointer-events: auto;
      `;
      ...
      `;
        ...
        setupEventListeners() {
            ...
            // Pass wheel events through to the element beneath so map zoom still works
            this.container.addEventListener('wheel', (e) => {
                e.preventDefault();
                this.container.style.pointerEvents = 'none';
                const below = document.elementFromPoint(e.clientX, e.clientY);
                this.container.style.pointerEvents = 'auto';
                if (below && below !== this.container) {
